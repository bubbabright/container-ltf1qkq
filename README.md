...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ltf1qkq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ltf1qkq.containers.anotherwebservice.com/
...
```
git clone git@github.com:bubbabright/container-ltf1qkq.git
cd container-ltf1qkq
```
...
```
docker attach container-ltf1qkq
```
